...
const factories = (() => {
    ...
    if(!localStorage.getItem('projects')) {  
        ...
        demoProject3.tasks.push(
            taskFactory('8', 'Start and maintain a workout routine','Start off with maybe two times a week and then step it up slowly.', dayjs(new Date(2021, 10, 14)).format('YYYY-MM-DD'), dayjs(new Date(2022, 5, 16)).format('YYYY-MM-DD'),'high'), 
        ...
        projectList[4].tasks[2].completionDate = dayjs(new Date(2022, 3, 25)).format('YYYY-MM-DD');
        projectList[4].tasks[3].completionDate = dayjs(new Date(2022, 3, 23)).format('YYYY-MM-DD');
        projectList[5].tasks.push(
            taskFactory('5', null, "There was once an invisible man who had grown tired of being unseen. It was not that he was actually invisible. It was that people had become used to not seeing him. And if no one sees you, are you really there at all? ― Patrick Ness, A Monster Calls", dayjs(new Date(2022, 3, 22)).format('YYYY-MM-DD'), null, 'very-high'),
            taskFactory('5', null, "Whereas, our argument shows that the power and capacity of learning exists in the soul already; and that just as the eye was unable to turn from darkness to light without the whole body, so too the instrument of knowledge can only by the movement of the whole soul be turned from the world of becoming into that of being, and learn by degrees to endure the sight of being, and of the brightest and best of being, or in other words, of the good. ― Plato, The Republic (Allegory of the Cave)", dayjs(new Date(2022, 1, 11)).format('YYYY-MM-DD'), null, 'medium'),
            taskFactory('5', null, "In debating the merits of pursuing hidden treasure, one must weigh the risk of whether it was never meant to be found and if so, why? ― Roshani Chokshi, The Silvered Serpents", dayjs(new Date(2021, 7, 27)).format('YYYY-MM-DD'), null, 'low'),
            taskFactory('5', null, "We are what we repeatedly do. Excellence, then, is not an act, but a habit. ― Will Durant", dayjs(new Date(2021, 11, 22)).format('YYYY-MM-DD'), null, 'high'),
            taskFactory('5', null, "Depending on who you ask, sometimes ghost stories are all that is left of history. History is full of ghosts, because it's full of myth. All of it woven together depending on who survived to do the telling. ― Roshani Chokshi, The Silvered Serpents", dayjs(new Date(2022, 1, 4)).format('YYYY-MM-DD'), null, 'medium'),
            )
